...
import { useAndromedaStore } from "@/zustand/andromeda";
  ...
  const ExchangeConfirmModal: FC<ExchangeConfirmModalProps> = (props) => {
    ...
    const displaySymbol = cw20Symbol === "AURA" ? "COSMIC" : cw20Symbol;
    return (
      <Box>
        ...
        <Box>
          <Text>Are you sure to spend {nativeAmount} {nativeDenom} for purchasing {nativeAmount / exchangeRate} {displaySymbol} ? </Text>
